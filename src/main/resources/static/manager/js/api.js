...
const Api = {
    ...
    // Pricing Policies
    getPricingPolicies() { return this.request('GET', '/pricings'); },
    getPricingPolicy(id) { return this.request('GET', '/pricings/' + id); },
    createPricingPolicy(data) { return this.request('POST', '/pricings', data); },
    updatePricingPolicy(id, data) { return this.request('PUT', '/pricings/' + id, data); },
    deletePricingPolicy(id) { return this.request('DELETE', '/pricings/' + id); },
