              ...
              <Col span={12}>
                ...
                <div style={{ textAlign: 'center' }}>
                  {summaryData.entryImage ? (
                    <img src={summaryData.entryImage.startsWith('http') ? summaryData.entryImage : `http://localhost:8080${summaryData.entryImage}`} alt="Entry" style={{ width: '100%', maxHeight: '200px', objectFit: 'contain', borderRadius: '8px', border: '1px solid #e8e8e8' }} />
                  ) : (
              ...
              <Col span={12}>
                ...
                <div style={{ textAlign: 'center' }}>
                  {summaryData.exitImage ? (
                    <img src={summaryData.exitImage.startsWith('http') ? summaryData.exitImage : `http://localhost:8080${summaryData.exitImage}`} alt="Exit" style={{ width: '100%', maxHeight: '200px', objectFit: 'contain', borderRadius: '8px', border: '1px solid #e8e8e8' }} />
                  ) : (
                    <div style={{ height: '200px', background: '#f5f5f5', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: '8px' }}>
                      <Text type="secondary" italic>No image available</Text>
                    </div>
